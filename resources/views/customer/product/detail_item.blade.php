                ...
                <div>
                    ...
                    <p class="mt-2 third-heading font-light">
                        Rp <span x-text="moneyFormat.format(harga)"></span> <span
                            class="text-[12px] md:text-[16px] lg:text-[25px]">/pcs</span>
                    </p>
                    <div class="my-4">
