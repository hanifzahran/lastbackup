    ...
    <div class="container">
        ...
        <div class="mt-[40px] flex items-start">
            <div class=" flex flex-col ">
                ...
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-progress ">2</div>
                    <div>
                ...
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">3</div>
                    <div>
                ...
                <div class="h-[80px] w-[4px] bg-gray-4 ml-[35px]"></div>
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">4</div>
                    <div>
                ...
                <div class="h-[80px] w-[4px] bg-gray-4 ml-[35px]"></div>
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">5</div>
                    <div>
                ...
                <div class="h-[80px] w-[4px] bg-gray-4 ml-[35px]"></div>
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">6</div>
                    <div>
                ...
                <div class="h-[80px] w-[4px] bg-gray-4 ml-[35px]"></div>
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">7</div>
                    <div>
                ...
                <div class="h-[80px] w-[4px] bg-gray-4 ml-[35px]"></div>
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">8</div>
                    <div>
                ...
                <div class="h-[80px] w-[4px] bg-gray-4 ml-[35px]"></div>
                <div class="flex gap-[50px] items-center">
                    <div class="pesanan-pending ">9</div>
                    <div>
