...
<div class="px-[24px]">
    ...
    <form action="" class="mt-[32px] max-w-[1175px]">
        ...
        <div class="mt-[32px] flex flex-col md:flex-row justify-end gap-[32px]">
            <button class="btn-center bg-primary md:w-[348px] text-white" type="submit">Simpan</button>
