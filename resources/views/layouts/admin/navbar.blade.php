<div>
    <nav class="bg-white shadow-md h-[115px] w-full flex items-center">
        <div class="flex justify-between w-full items-center">
            ...
            <div class="mr-[12px]">
                <div
                    class="border max-w-[200px] md:max-w-[300px]  border-[#828282] rounded-[10px] flex items-center h-[40px] md:h-[63px] px-[12px] py-[8px]">
                    <span class="mi mr-[8px]">
                        search
                    </span>
                    <input type="text" class="focus:outline-none w-full   rounded-[10px] h-full text-lg">
                </div>
            </div>
        </div>
    </nav>
